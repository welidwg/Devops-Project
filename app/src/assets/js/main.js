...
//   slide: function (event, ui) {
//     $("#caramount").val(
//       "$" + ui.values[0] + " - $" + ui.values[1] + ".100"
//     );
//   },
// });
// $("#caramount").val(
//   "$" +
//     $(".car-price-range").slider("values", 0) +
//     " - $" +
//     $(".car-price-range").slider("values", 1) +
//     ".100"
// );
...
//   "[ " +
//     "$" +
//     $(".filter-price-range").slider("values", 0) +
//     " - $" +
//     $(".filter-price-range").slider("values", 1) +
//     " ]"
// );
